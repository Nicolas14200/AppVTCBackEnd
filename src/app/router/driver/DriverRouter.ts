...
import { CarApiResponseMapper } from "../user/mappers/CarApiResponseMapper";
...
const carApiResponseMapper = new CarApiResponseMapper()
...
driverRouter.post("/createCar", async (req: Request, res: Response)=>{
    try{
        ...
        const toApiresponse = carApiResponseMapper.fromDomain(car)
